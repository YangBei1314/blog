...
<br />
<form name="form1" method="post" action="/admin.php/Links/insert">
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="border">
	<tr class="title">
		<td colspan="2" align="center">添加友情链接</td>
	</tr>
	<tr class="tdbg">
		<td width="11%" height="30" align="right">域&nbsp;&nbsp;名：</td>
		<td width="89%"><input name="domain" type="text" size="90" maxlength="50" /></td>
	</tr>
	<tr class="tdbg">
		<td width="11%" height="30" align="right">网&nbsp;&nbsp;址：</td>
		<td width="89%"><input name="url" type="text" size="90" maxlength="50" /></td>
	</tr>
	<tr class="tdbg">
