...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="border">
	...
	<tr class="tdbg">
	  <td height="30">&nbsp;&nbsp;<a href="/admin.php/User/index">管理首页</a>&nbsp;|&nbsp;<a href="/admin.php/User/add">添加用户</a></td>
	</tr>
</table>
<br />
<form id="form1" name="form1" method="post" action="/admin.php/User/insert" onsubmit="return checkForm()">
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="border">
	...
	<tr class="tdbg">
		...
		<td width="85%">
			...
			<font color="#666666">长度为5-15位（字母、数字），不能含有特殊符号</font>
		</td>
	</tr>
	<tr class="tdbg">
	...
	<tr class="tdbg">
		...
		<td>
			<input name="confirmpwd" type="password" id="confirmpwd" size="20" maxlength="15" />
			<font color="#FF0000">*</font>
			<font color="#666666">两次输入的密码必须一致</font>
		</td>
	</tr>
	<tr class="tdbg">
		<td height="30" align="right">真实姓名：</td>
		<td>
			<input name="name" type="text" id="name" size="20" maxlength="15" />
			<font color="#FF0000">*</font> <font color="#666666">你的姓名</font>
		</td>
	</tr>
	<tr class="tdbg">
